...
const hotelRoom ={
    ...
    fields: [
        ...
        defineField({
            ...
            title: 'Description',
            type: 'text',
            validation: Rule => Rule.required().max(100).error('Minimum 50 characters'),
        }),
        defineField({
            name: 'price',
            title: 'Price',
        ...
        defineField({
            ...
            type: 'text',
            validation:Rule => Rule.required(),
            initialValue: 'Check-in time is 12:00 Pm, checkout time is 11:59 AM. If you leave any item of yours behind please contact our receptionist',
        }),
        defineField({
            name: 'dimension',
            title: 'Dimension',
